...
We will start grading the summaries for Period #7 after 27th May and will publish the scores well in advance of the next scoring period (Period #9).
...
- `dapplooker` for developing a [stats page](https://dapplooker.com/dapp/joystream-12) using our query node which provides live information on the testnet.
...
- `joystreamenthusiast` for creating an attractive animated video about the project.
