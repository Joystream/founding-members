...
_Scoring Period #16 is now live!_
...
- `l1dev`, `isonar`, `ururu` and `lkskrn` for their work in the Operations Working Group.
...
- `chiffah` and `svasilenko` for their support work in the Russian Telegram group, and Council membership.
